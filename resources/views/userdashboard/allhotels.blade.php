                ...
                <div class="container">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
                            <div class="col-list-search-input-item fl-wrap location autocomplete-container">
                                ...
                                <span class="header-search-input-item-icon"><i
                                        class="fa fa-cart-plus icon_cart"></i></span>
                                <input type="text" placeholder="Destination or Hotel Name"
                                    class="autocomplete-input form-control" id="autocompleteid3" value="" />
                            </div>
                        </div>
                        <!-- col-list-search-input-item end -->
                        <!-- col-list-search-input-item -->
                    ...
                    <div class="search-opt-wrap fl-wrap">
                        <div class="search-opt-wrap-container">
                            ...
                            <div class="search-input-item small-input ">
                                <div class="col-list-search-input-item fl-wrap">
                                    <button class="btn_all_hotel" onclick="window.location.href='listing.html'">Search
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        <a href="#"><img src="{{asset('userdashboard/images/gal/4.jpg')}}" alt=""></a>
                                        <div class="listing-avatar"><a href="#"><img
                                                    src="{{asset('userdashboard/images/avatar/2.jpg')}}" alt=""></a>
                                            <span class="avatar-tooltip">Manager : <strong>Julie Cramp</strong></span>
                                        </div>
                                        <div class="sale-window big-sale">Sale 50%</div>
                                        <div class="geodir-category-opt">
                                        ...
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                ...
                                                <div class="geodir-category-location fl-wrap"><a href="#1"
                                                        class="map-item"><i class="fas fa-map-marker-alt"></i> W 85th
                                                        St, New York, USA</a></div>
                                            </div>
                                        </div>
                                        <p> Morbi suscipit erat in diam bibendum rutrum in nisl. Aliquam et purus ante.
                                        </p>
                                        <ul class="facilities-list fl-wrap">
                                            <li><i class="fal fa-wifi"></i><span>Free WiFi</span></li>
                                            <li><i class="fal fa-parking"></i><span>Parking</span></li>
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        <a href="#"><img src="{{asset('userdashboard/images/gal/6.jpg')}}" alt=""></a>
                                        <div class="listing-avatar"><a href="#"><img
                                                    src="{{asset('userdashboard/images/avatar/3.jpg')}}" alt=""></a>
                                            <span class="avatar-tooltip">Manager : <strong>Andy Moore</strong></span>
                                        </div>
                                        <div class="sale-window">Sale 28%</div>
                                        <div class="geodir-category-opt">
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        <a href="#"><img src="{{asset('userdashboard/images/gal/2.jpg')}}" alt=""></a>
                                        <div class="listing-avatar"><a href="#"><img
                                                    src="{{asset('userdashboard/images/avatar/4.jpg')}}" alt=""></a>
                                            <span class="avatar-tooltip">Manager : <strong>Mary Jones</strong></span>
                                        </div>
                                        <div class="sale-window">Sale 20%</div>
                                        <div class="geodir-category-opt">
                                        ...
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                ...
                                                <div class="geodir-category-location fl-wrap"><a href="#3"
                                                        class="map-item"><i class="fas fa-map-marker-alt"></i> 75 Prince
                                                        St, NY, USA</a></div>
                                            </div>
                                        </div>
                                        <p> Mauris ac maximus neque. Nam in mauris quis libero sodales eleifend.</p>
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        <a href="#"><img src="{{asset('userdashboard/images/gal/3.jpg')}}" alt=""></a>
                                        <div class="listing-avatar"><a href="#"><img
                                                    src="{{asset('userdashboard/images/avatar/5.jpg')}}" alt=""></a>
                                            <span class="avatar-tooltip">Manager : <strong>Fider Mamby</strong></span>
                                        </div>
                                        <div class="sale-window">Sale 10%</div>
                                        <div class="geodir-category-opt">
                                        ...
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                ...
                                                <div class="geodir-category-location fl-wrap"><a href="#5"
                                                        class="map-item"><i class="fas fa-map-marker-alt"></i> 70 Bright
                                                        St New York, USA</a></div>
                                            </div>
                                        </div>
...
<<<<<<< HEAD
<script src="https://www.google.com/maps/place/%D8%A7%D9%84%D9%88%D9%84%D8%A7%D9%8A%D8%A7%D8%AA+%D8%A7%D9%84%D9%85%D8%AA%D8%AD%D8%AF%D8%A9%E2%80%AD/@39.6123384,-101.3144006,9.95z/data=!4m5!3m4!1s0x54eab584e432360b:0x1c3bb99243deb742!8m2!3d37.09024!4d-95.712891"></script>
...
=======
<script
    src="https://www.google.com/maps/place/%D8%A7%D9%84%D9%88%D9%84%D8%A7%D9%8A%D8%A7%D8%AA+%D8%A7%D9%84%D9%85%D8%AA%D8%AD%D8%AF%D8%A9%E2%80%AD/@39.6123384,-101.3144006,9.95z/data=!4m5!3m4!1s0x54eab584e432360b:0x1c3bb99243deb742!8m2!3d37.09024!4d-95.712891">
</script>
<script type="text/javascript" src="{{asset('userdashboard/js/mapplugins.js')}}"></script>
<script type="text/javascript" src="{{asset('userdashboard/js/maps.js')}}"></script>
