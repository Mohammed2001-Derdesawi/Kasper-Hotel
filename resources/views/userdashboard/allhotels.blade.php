...
<div class="col-list-wrap left-list">
    ...
    <div class="list-main-wrap fl-wrap card-listing">
        <div class="container">
            ...
            @foreach ($country->hotels as $datahotels)
            <div class="listing-item-contain    er init-grid-items">
               <!-- listing-item  -->
               <div class="listing-item">
                   <article class="geodir-category-listing fl-wrap">
                       <div class="geodir-category-img">
                   <a href="{{ url('dashboard/hotel/view/'.$datahotels->country_id) }}">
                            <img src="{{asset($datahotels->images()->first()->imageName)}}" alt=""/>
                        </a>
                           <div class="listing-avatar"><a href="{{ url('dashboard/hotel/view/'.$datahotels->country_id) }}">
                            <img src="{{asset($datahotels->manager->image)}}" alt="" /></a>
