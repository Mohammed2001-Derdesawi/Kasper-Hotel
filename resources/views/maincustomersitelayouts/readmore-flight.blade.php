    ...
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><b>K</b>asper
          </a>
        </div>
        <!-- right -->
          ...
          <div class="row">
               <div class="col-lg-8 col-12">
                     <div class="item_right"><!--start item_right-->
                           <div class="img_blog">
                                <img src="{{asset("maincustomersiteresources/images/readmore/flight.jpg")}}" alt="imag blog">
                           </div>
                 ...
                 <div class="col-lg-4 col-12">
                   ...
                   <div class="recent_post"><!--start  recent_post-->
                       <h2>Recent Posts</h2>
                       <h3><a href="#">Blog title goes to here</a> </h3>
                       <span><a href="#">24 May 2021</a></span>
                       <h3><a href="#">Blog title goes to here</a> </h3>
                       <span><a href="#">24 May 2021</a></span>
                       <h3><a href="#">Blog title goes to here</a> </h3>
                       <span><a href="#">24 May 2021</a></span>
              ...
              <div class="items_message">
                       <div class="item"><!--start item-->
                           <div class="div_img_mesg">
                               ...
                               <img src="{{asset("maincustomersiteresources/images/1.jpeg")}}" alt="image person">
                           </div>
                       ...
                       <div class="item"><!--start item-->
                           <img src="{{asset("maincustomersiteresources/images/2.jpeg")}}" alt="image person">
                           <div class="desc_person_message">
                                        <h3>Nick Leaver</h3>
                       ...
                       <div class="item"><!--start item-->
                           <img src="{{asset("maincustomersiteresources/images/3.jpeg")}}" alt="image person">
                           <div class="desc_person_message">
                                        <h3>Nick Leaver</h3>
