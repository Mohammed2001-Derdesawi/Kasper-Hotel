                        ...
                        <tbody>
                            ...
                            @foreach ($countries as $country)
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    <td>{{ $country->name }}</td>
                                    <td>{{ $country->hotels()->count() }}</td>
                                    <td>{{ $country->cities()->count() }}</td>
                                    <td>{{ $country->manager->name }}</td>
                                    <td>{{ $country->manager->email }}</td>
                                        ...
                                        <div class="form-group"
                                            ...
                                            <div class="">
                                                <a class="btn btn-primary btn-edit" id="buttoneditCountry"
                                                    ...
                                                    data-countryid="{{ $country->id }}" data-name="{{ $country->name }}"
                                                    data-manager="{{ $country->manager_id }}"> <i
                                                        class="kt-font-brand flaticon2-edit"></i></a>
                                            </div>
                                            <div class="">
                                                <form action="{{ route('admin.country.remove', $country->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('POST')
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 selDiv" >
                                        <select name="manager_id"
                                            class="form-control @error('manager_id') is-invalid @enderror SlectBox" id="myselect">

                                            @foreach ($manager as $managers)
                                                <option value=" {{ $managers->id }}" id="selectmanager{{$managers->id}}"

                                               > {{ $managers->name }} </option>
                                            @endforeach
        ...
        $(function() {
            $('#countryadd').submit(function(e) {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: () => window.location.assign("{{ route('admin.country') }}"),
                    error: (response) => {
