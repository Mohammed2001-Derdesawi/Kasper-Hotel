        ...
        <div class="kt-portlet__body" id="print">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ++$i }}</td>
                        <td>{{ $user->name == Null ? 'UnKnown' : $user->name }}</td>
                        <td>{{ $user->email }}</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-left" style="padding-top: 25px">
                    <p style="color: #fa2c27; display: inline-block;"> Booking Now  : </p>

                    <p style="display: inline-block; padding-left: 10px;" id="userhotelname"></p>
                    <p style="display: inline-block; padding-left: 10px;" id="userhotelcountry"></p>
                    <p style="display: inline-block; padding-left: 10px;" id="userstartdate"></p>
                    <p style="display: inline-block; padding-left: 10px;" id="userenddate"></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var data_hotel =$(this).data('hotel');
    var data_country = $(this).data('country');
    var  data_startdate = $(this).data('startdate');
    var   data_enddate = $(this).data('enddate');
    ...
    $("#userhotelname").text(data_hotel);
    $("#userhotelcountry").text(data_country);
    $("#userstartdate").text(data_startdate);
    $("#userenddate").text(data_enddate);
