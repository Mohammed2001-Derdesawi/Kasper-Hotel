...
<div class="kt-container  kt-container--fluid  kt-grid_item kt-grid_item--fluid">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <form class="kt-form kt-form--fit kt-form--label-right" action="{{route('admin.posts.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="form-group row">
            <label>Title</label>
            <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Title" name="title" value="{{old('title')}}">
            @error('title')
            <div class="row">
                <div class="col-lg-12">
